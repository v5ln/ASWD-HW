...
int getNumberOfDays(int month, int year) { //returns the number of days in given month
 ...
 const char* getName(int day) { //returns the name of the day
    switch (day) {
...
int DayNumber(int day, int mon, int year) { //retuns the day number
